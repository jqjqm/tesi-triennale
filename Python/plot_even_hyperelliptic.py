...
def genera_grafici_tesi(nome_file_csv):
    output_dir = "grafici_iperellittiche_pari"
    ...
    with open(nome_file_csv, 'r') as f:
        for riga in f:
            ...
            plt.bar(punti, frequenze, color='orange', edgecolor='black', alpha=0.8, width=0.8)
            ...
            plt.title(f'Distribuzione punti Iperellittiche ($y^2=f(x^2)$) su $\mathbb{{F}}_{{{q_str}}}$\n')
...
if __name__ == "__main__":
    ...
    genera_grafici_tesi("iperellittiche_pari_dati.csv")